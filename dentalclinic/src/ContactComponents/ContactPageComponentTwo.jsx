...
const ContactPageComponentTwo = () => {
      ...
      const contactcontenttwo = useRef();
        ...
        gsap.from(contactcontentone.current, {
          opacity: 0,
          scale: 0.95,
          duration: 1,
          ease: "power3.out",
            x:-50,
          scrollTrigger: {
            trigger: contactcontentone.current,
            start: "top 85%",   // jab element ka top, viewport ke 80% pe pohanche
            // end: "top 50%",
            toggleActions: "play none none reverse",
          }
        });
          gsap.from(contactcontenttwo.current, {
          opacity: 0,
          scale: 0.95,
          duration: 1,
          ease: "power3.out",
          scrollTrigger: {
            trigger: contactcontenttwo.current,
            start: "top 85%",   // jab element ka top, viewport ke 80% pe pohanche
            end: "top 50%",
            toggleActions: "play none none reverse",
          }
  ...
  return (
    <div>
         ...
         <div className=" mx-5 lg:mx-0 mt-3 lg:mt-5  inline-flex w-fit items-center gap-2 bg-teal-50 border border-teal-700 rounded-full px-12 py-4 shadow-sm" ref={contactcontentone}>
      <span className="text-teal-700  text-md font-bold">Book Appoitment</span>
    </div>
<h2 className="px-5 lg:px-0 text-3xl lg:text-5xl font-bold pt-8 text-[var(--heading)]" ref={contactcontentone}>
  Schedule Your Visit
</h2>

<p className="px-5 lg:px-0 mt-2 text-[var(--text)] text-lg" ref={contactcontenttwo}>
